...
{
    public sealed partial class HintSettingsDialog : Page
    {
        ...
        /// Constructor
        /// </summary>
        public HintSettingsDialog(ViewModel.BoardViewModel pBoardVM)
        {
            this.InitializeComponent();
            _boardVM = pBoardVM;

            // Set initial values
            HintCheckBox.IsChecked = _boardVM.HintEnabled;
            HintMoveCheckBox.IsChecked = _boardVM.HintMoveEnabled;
        }
        ...
        private void Save()
        {   
            _boardVM.HintEnabled = HintCheckBox.IsChecked == true;
            _boardVM.HintMoveEnabled = HintMoveCheckBox.IsChecked == true;
