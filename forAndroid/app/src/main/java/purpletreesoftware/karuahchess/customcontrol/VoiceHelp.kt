...
import purpletreesoftware.karuahchess.databinding.FragmentVoicehelpBinding

@ExperimentalUnsignedTypes
class VoiceHelp : DialogFragment() {
    private var _binding: FragmentVoicehelpBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val fragmentBinding = FragmentVoicehelpBinding.inflate(inflater, container, false)
